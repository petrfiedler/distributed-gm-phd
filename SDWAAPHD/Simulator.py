...
class Simulator:
    """
    A simulator for the collaborative SD-WAA GM-PHD filter network.
    """
    ...
    def copy(self):
        ...
        """
        one_phd = list(self.sdwaaphd.phds.values())[0]
        return Simulator(
            radars=self.radar_network.radars,
            graph=self.sdwaaphd.graph,
    ...
    def step(self):
        ...
        self.sdwaaphd.step(measurements)
    ...
    def simulate(
        ...
        for _ in range(steps):
            ...
            if calculate_gospa:
                ...
                for phd in self.sdwaaphd.phds.values():
